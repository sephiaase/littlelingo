...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $conn->close();
  header("Location: menu-6.php#forum");
  exit;
}
?>
...
<head>
  ...
  <title>LittleLingo - My Future & My Dreams</title>
...
<section class="max-w-6xl mx-auto px-4 py-12">
  <div class="text-center mb-10">
    <h2 class="text-3xl font-bold">Your <em class='text-yellow-500'>Dreams & Goals</em></h2>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
      ...
      <div class="p-6">
        ...
        <h3 class="text-xl font-bold mb-2">My Future & My Dreams</h3>
        <p class="text-gray-500 text-sm mb-4">Latih kemampuan mengekspresikan cita-cita</p>
        <div class="flex items-center justify-between">
          <a href="kuis-6.html" class="bg-blue-500 text-white text-sm px-6 py-4 rounded-full hover:bg-blue-600 transition">Kerjakan Kuis Sekarang!</a>
        </div>
      </div>
    </div>

    <div class="flex flex-col space-y-6">
      <a href="reading-6.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Impian Masa Depan</h4>
          <p class="text-gray-500 text-sm">Pelajari bagaimana mengungkapkan impian masa depan.</p>
        </div>
      </a>

      <a href="listening-6.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Mendengarkan Impian</h4>
          <p class="text-gray-500 text-sm">Dengarkan dan pahami kalimat tentang mendengarkan impian.</p>
        </div>
      </a>

      <a href="uploads/materi/My Future and My Dreams-6.pdf" download class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Materi Impian dan Harapan</h4>
...
<section class="bg-gray-100 py-12 mt-16" id="forum">
  <div class="max-w-4xl mx-auto px-4">
    ...
    <div class="mt-8 space-y-4">
      ...
      $sql = "SELECT * FROM comments WHERE level = 6 ORDER BY created_at DESC";
