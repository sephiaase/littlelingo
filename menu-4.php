...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $conn->close();
  header("Location: menu-4.php#forum");
  exit;
}
?>
...
<head>
  ...
  <title>LittleLingo - School and Friends</title>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between py-4 relative">
      ...
      <div class="absolute left-1/2 transform -translate-x-1/2">
        <span class="font-bold text-xl text-blue-600">School and Friends</span>
      </div>
...
<section class="max-w-6xl mx-auto px-4 py-12">
  <div class="text-center mb-10">
    <h2 class="text-3xl font-bold">Your <em class='text-yellow-500'>School Life</em></h2>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
      ...
      <div class="p-6">
        ...
        <h3 class="text-xl font-bold mb-2">School and Friends</h3>
        <p class="text-gray-500 text-sm mb-4">Belajar tentang kegiatan sekolah & pertemanan</p>
        <a href="kuis-4.html" class="bg-blue-500 text-white text-sm px-6 py-4 rounded-full hover:bg-blue-600 transition">Kerjakan Kuis Sekarang!</a>
      </div>
    </div>

    <div class="flex flex-col space-y-6">
      <a href="reading-4.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Kegiatan di Sekolah</h4>
          <p class="text-gray-500 text-sm">Pelajari bagaimana mengungkapkan kegiatan di sekolah.</p>
        </div>
      </a>

      <a href="listening-4.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Teman dan Sekolah</h4>
          <p class="text-gray-500 text-sm">Dengarkan dan pahami kalimat tentang teman dan sekolah.</p>
        </div>
      </a>

      <a href="uploads/materi/School and Friends-4.pdf" download class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Materi Kehidupan Sekolah</h4>
          <p class="text-gray-500 text-sm">Unduh materi PDF untuk memperkuat pemahaman.</p>
        </div>
      </a>
    </div>
  </div>
...
<section class="bg-gray-100 py-12 mt-16" id="forum">
  <div class="max-w-4xl mx-auto px-4">
    ...
    <p class="text-center text-gray-600 mb-8">Tanyakan apapun tentang topik atau materi di level ini.</p>
    ...
    <div class="mt-8 space-y-4">
      ...
      $sql = "SELECT * FROM comments WHERE level = 4 ORDER BY created_at DESC";
