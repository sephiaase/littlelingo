...
// Ambil data tugas level 4 tipe reading
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'reading' AND level = 4 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>Reading Level 4 - LittleLingo</title>
...
<section class="py-12 px-4 max-w-7xl mx-auto">
  <div class="text-center mb-10">
    <h6 class="text-blue-600 font-semibold uppercase text-sm">SCHOOL AND FRIENDS</h6>
    <h2 class="text-3xl font-bold">Reading is Fun with <span class="text-blue-500">Friends</span></h2>
  </div>
  ...
  <div class="text-center mt-12">
    <a href="menu-4.php" class="inline-block bg-blue-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-pink-600 transition">Kembali ke Menu</a>
  </div>
</section>
