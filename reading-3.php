...
// Ambil data tugas level 3 tipe reading
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'reading' AND level = 3 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>Reading Level 3 - LittleLingo</title>
...
<section class="py-12 px-4 max-w-7xl mx-auto">
  <div class="text-center mb-10">
    <h6 class="text-blue-600 font-semibold uppercase text-sm">DAILY ACTIVITIES</h6>
    <h2 class="text-3xl font-bold">Let’s Read About <span class="text-blue-500">Daily Routines</span></h2>
  </div>
