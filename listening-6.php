...
// Ambil data tugas listening level 6
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'listening' AND level = 6 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>LittleLingo Listening - Level 6</title>
