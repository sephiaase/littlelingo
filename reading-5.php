...
// Ambil data tugas level 5 tipe reading
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'reading' AND level = 5 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>Reading Level 5 - LittleLingo</title>
...
<section class="py-12 px-4 max-w-7xl mx-auto">
  <div class="text-center mb-10">
    <h6 class="text-blue-600 font-semibold uppercase text-sm">MY EXPERIENCES</h6>
    <h2 class="text-3xl font-bold">Explore Your <span class="text-blue-500">Reading Journey</span></h2>
  </div>
  ...
  <div class="text-center mt-12">
    <a href="menu-5.php" class="inline-block bg-blue-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-pink-600 transition">Kembali ke Menu</a>
  </div>
</section>
