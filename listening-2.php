...
// Ambil data tugas listening level 2
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'listening' AND level = 2 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>LittleLingo Listening - Level 2</title>
