...
// Ambil data tugas level 1 tipe reading
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'reading' AND level = 1 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>Reading - LittleLingo</title>
