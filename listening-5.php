...
// Ambil data tugas listening level 5
$result = $conn->query("SELECT * FROM tugas WHERE tipe = 'listening' AND level = 5 ORDER BY created_at DESC");
$tugas = [];
...
<head>
  ...
  <title>LittleLingo Listening - Level 5</title>
...
<section class="py-12 px-4 max-w-7xl mx-auto">
  <div class="text-center mb-10">
    <h6 class="text-blue-600 font-semibold uppercase text-sm">EXPERIENCES</h6>
