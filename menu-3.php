...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $conn->close();
  header("Location: menu-3.php#forum");
  exit;
}
?>
...
<head>
  ...
  <title>LittleLingo - Daily Activities</title>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
    ...
    <div class="bg-white rounded-3xl shadow-lg overflow-hidden">
      ...
      <div class="p-6">
        ...
        <h3 class="text-xl font-bold mb-2">Daily Activities</h3>
        <p class="text-gray-500 text-sm mb-4">Uji pemahamanmu tentang kegiatan sehari-hari!</p>
        <a href="kuis-3.html" class="bg-blue-500 text-white text-sm px-6 py-4 rounded-full hover:bg-blue-600 transition">Kerjakan Kuis Sekarang!</a>
      </div>
    </div>

    <!-- Reading, Listening, Materi -->
    <div class="flex flex-col space-y-6">
      <a href="reading-3.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Kebiasaan Pagi Hari</h4>
          <p class="text-gray-500 text-sm">Pelajari bagaimana menjelaskan rutinitas harian dalam bahasa Inggris.</p>
        </div>
      </a>

      <a href="listening-3.php" class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Kegiatan Sehari-hari Teman</h4>
          <p class="text-gray-500 text-sm">Latih telinga kamu dengan mendengarkan cerita kegiatan teman-teman.</p>
        </div>
      </a>

      <a href="uploads/materi/Daily Activities-3.pdf" download class="flex items-start space-x-4 hover:bg-blue-50 p-2 rounded-xl transition">
        ...
        <div>
          ...
          <h4 class="font-semibold mt-1">Deskripsi Rutinitas</h4>
          <p class="text-gray-500 text-sm">Unduh materi PDF dan pelajari struktur kalimat tentang rutinitas harian.</p>
        </div>
      </a>
    </div>
  </div>
...
<section class="bg-gray-100 py-12 mt-16" id="forum">
  <div class="max-w-4xl mx-auto px-4">
    ...
    <p class="text-center text-gray-600 mb-8">Tanyakan apapun tentang rutinitas harian, materi atau kuis!</p>
    ...
    <div class="mt-8 space-y-4">
      ...
      $sql = "SELECT * FROM comments WHERE level = 3 ORDER BY created_at DESC";
